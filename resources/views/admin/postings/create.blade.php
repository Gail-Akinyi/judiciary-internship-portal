<x-admin-layout :title="'Add Job Posting'">

    <div class="form-card">
        <form method="POST" action="{{ route('admin.postings.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" rows="5" required style="width:100%; padding:10px 12px; border:1px solid var(--line); border-radius:5px; font-size:0.92rem; font-family:inherit;">{{ old('description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select id="is_active" name="is_active" required>
                    <option value="1" @selected(old('is_active', '1') === '1')>Active (visible on homepage)</option>
