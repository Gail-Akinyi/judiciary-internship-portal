...
<head>
    ...
    <title>{{ $title ?? 'Supervisor' }} — JIMP</title>
    <style>
        :root {
...
<body>
    ...
    <aside class="sidebar">
        <div class="brand">
            ...
            <div class="subname">Supervisor Panel</div>
        </div>
        <nav>
            <a href="{{ route('supervisor.dashboard') }}" class="{{ request()->routeIs('supervisor.dashboard') ? 'active' : '' }}">Dashboard</a>
        </nav>
